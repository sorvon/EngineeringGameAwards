...
namespace TMPro
{
    ...
    public class TMP_TextEventHandler1 : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
    {
        [Serializable]
        ...
        public void OnAnnoWordEnter(string annoWord)
        {
            if (annoWord == annoWord1)
            {
                annotationText = annoText1;
            }
            if (annoWord == annoWord2)
            {
                annotationText = annoText2;
            }
            if (infoImage != null)
